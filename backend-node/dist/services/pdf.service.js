...
exports.generateSummaryPdf = exports.generateTaskAnalysisPdf = void 0;
...
const renderTextWithBold = (doc, text) => {
...
const generateTaskAnalysisPdf = (task) => {
...
exports.generateTaskAnalysisPdf = generateTaskAnalysisPdf;
// Gera o resumo em um PDF para a vendedora
const generateSummaryPdf = (saleswomanName, summaryContent) => {
    return new Promise((resolve) => {
        const doc = new pdfkit_1.default({
            size: 'A4',
