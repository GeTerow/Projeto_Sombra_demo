...
import { UploadIcon, UsersIcon, ChartBarIcon, SunIcon, MoonIcon, CogIcon, LogoutIcon } from './icons';
import type { View, Theme } from '@/App';

interface HeaderProps {
  currentView: View;
  onViewChange: (view: 'upload' | 'dashboard' | 'settings') => void;
  theme: Theme;
  onThemeToggle: () => void;
  onLogout: () => void;
}
...
export const Header: React.FC<HeaderProps> = ({ currentView, onViewChange, theme, onThemeToggle, onLogout }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={onLogout}
              className="p-2 rounded-full text-slate-500 hover:text-red-500 dark:text-slate-400 dark:hover:text-red-400 hover:bg-slate-200 dark:hover:bg-slate-700"
              aria-label="Sair"
            >
