        ...
        <div className="max-w-5xl mx-auto p-4 md:p-8">
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button disabled title="Desativado no modo de demonstração" className="inline-flex items-center gap-2 text-sm font-medium px-3.5 py-2 rounded-lg bg-gradient-to-r from-primary-500 to-indigo-500 text-white disabled:opacity-50 disabled:cursor-not-allowed">
                        ...
                        {activeView === 'summary' && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="w-full bg-slate-100 dark:bg-slate-900/40 p-4 rounded-lg text-center text-sm text-slate-500 dark:text-slate-400">
                                        Player de áudio desativado na demonstração.
                                    </div>
                                    <div className="mt-6 p-4 rounded-lg bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-700">
                                        ...
                                        {canAnalyze && (
                                            <>
                                                <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">A análise por IA está desativada nesta versão de demonstração.</p>
                                                <button disabled className="inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-lg bg-primary-600 text-white disabled:opacity-50 disabled:cursor-not-allowed">
                                                  <LightbulbIcon className="w-5 h-5" />Analisar com IA
                                                </button>
                                            </>
                                        )}
                                        {isAnalyzing && (<div className="flex items-center gap-3 text-sm text-indigo-600 dark:text-indigo-400"><Spinner /><span>Simulando análise...</span></div>)}
